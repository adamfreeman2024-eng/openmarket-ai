...
/** Default settlement asset for MVP quotes */
...
export function marketCard() {
  return {
    ...
    version: "0.1.0",
    description:
      "Agent-to-agent marketplace on Hedera — x402 settlement, policy-safe spend, micro-fees",
    network: NETWORK === "mainnet" ? "hedera-mainnet" : "hedera-testnet",
    settlement: ["x402", "hbar", "hts-usdc-planned"],
    fees: {
