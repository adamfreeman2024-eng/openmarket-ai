...
export async function GET(req: NextRequest) {
  ...
  return json({
    ...
    agent: {
      ...
      githubHandle: agent.githubHandle || undefined,
      auditRepositoryUrl: agent.auditRepositoryUrl || undefined,
      lastAuditSummary: agent.lastAuditSummary || undefined,
      lastAuditAt: agent.lastAuditAt || undefined,
      internalBalance: Number(agent.internalBalance ?? 0),
